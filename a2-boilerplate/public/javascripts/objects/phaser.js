...
__phaser = {
    ...
    canvas:{
      ...
      init(){
            ...
            var game = new Phaser.Game(1080, 800, Phaser.WEBGL, assets.canvas, { preload: preload, create: create, update: update, render: render });
            assets.gameObj = game;
            ...
            function preload() {
                ...
                game.load.image('bullet', 'media/game/bullet.png');
                game.load.image('enemyBullet', 'media/game/enemy-bullet.png');
                game.load.spritesheet('invader', 'media/game/invader32x32x4.png', 32, 32);
                game.load.image('ship', 'media/game/player.png');
                game.load.spritesheet('kaboom', 'media/game/explode.png', 128, 128);
                game.load.image('starfield', 'media/game/starfield.png');
                game.load.image('background', 'media/game/background2.png');
            ...
            function create() {
                ...
                starfield = game.add.tileSprite(0, 0, 1080, 800, 'starfield');
